%-----------------------------------------------------------------------
% to plot t_on as a function of h & Pe
%-------------------------------------------------------------------------
...
for k=1:size(hv,2)
plot1(k)=plot(Pev,t_on(k,:),'LineWidth',2,'Marker','none',MarkerIndices=1:6:length(Pev));
hold on
end
...
exportgraphics(gcf,'fig9a.jpg','Resolution',600)