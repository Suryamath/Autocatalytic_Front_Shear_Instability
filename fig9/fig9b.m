%-----------------------------------------------------------------------
% to plot I_max as a function of h & Pe
%-------------------------------------------------------------------------
close all;
clear all;
clc;
...
for k=1:size(hv,2)
plot1(k)=plot(Pev,imax(k,:),'LineWidth',2,'Marker','none',MarkerIndices=1:6:length(Pev));
hold on
end
...
xlabel('$Pe$','FontWeight','bold','FontSize',24,'Interpreter','latex');
...
exportgraphics(gcf,'fig9b.jpg','Resolution',600);