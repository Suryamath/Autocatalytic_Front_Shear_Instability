...
plot1(k)=plot(Base_data.y,Base_data.mu,DisplayName=sprintf('$t_{f}=%.1f$',(k-1)*2500*0.0002), ...
        LineWidth=2);
hold on
end
...
% Create ylabel
ylabel({'$\bar{\mu}$'},'FontWeight','bold','FontSize',24,'Interpreter','latex');
...
exportgraphics(gcf,'fig3b.jpg','Resolution',600)