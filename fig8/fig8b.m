%-----------------------------------------------------------------------
% to plot I_max as a function of h & Da
%-------------------------------------------------------------------------
...
for k=1:size(hv,2)
plot1(k)=plot(Dav,imax(k,:),'LineWidth',2,'Marker','none',MarkerIndices=1:6:length(Dav));
hold on
end
...
exportgraphics(gcf,'fig8b.jpg','Resolution',600);