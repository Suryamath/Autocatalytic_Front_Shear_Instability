%-----------------------------------------------------------------------
% to plot t_on as a function of h & Da
%-------------------------------------------------------------------------
...
for k=1:4
plot1(k)=plot(Dav,t_on(k,:),'LineWidth',2,'Marker','none',MarkerIndices=1:6:length(Dav));
hold on
end
...
exportgraphics(gcf,'fig8a.jpg','Resolution',600)